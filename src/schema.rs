...
diesel::table! {
    claims (id) {
        ...
        outstanding_primary_payor_amount -> Nullable<Numeric>,
        outstanding_secondary_payor_amount -> Nullable<Numeric>,
        outstanding_patient_amount -> Nullable<Numeric>,
...
diesel::table! {
    encounters (id) {
        ...
        snomed_code -> Nullable<Text>,
        description -> Nullable<Text>,
        base_encounter_cost -> Nullable<Numeric>,
        total_claim_cost -> Nullable<Numeric>,
        payer_coverage -> Nullable<Numeric>,
        reasoncode -> Nullable<Text>,
...
diesel::table! {
    payers (id) {
        ...
        zip -> Nullable<Text>,
        phone -> Nullable<Text>,
        amount_covered -> Nullable<Numeric>,
        amount_uncovered -> Nullable<Numeric>,
        revenue -> Nullable<Numeric>,
